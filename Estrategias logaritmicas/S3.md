...
Pivot guarda lo que hay en la posicion P, lo cual es el segundo elemento
i es el indice P-1

Mientras i no sea 0 y el elemento en el indice i sea mayor a pivot
- Cambiamos lo que hay en la posicion i+1 por lo que hay en el indice i
- Restamos 1 a i o nos movemos una posicion hacia atras en el arreglo con i
