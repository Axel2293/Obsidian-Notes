...
| c1 |  |  |  |
## Selection sort
Mantenemos un pivote, minimo e iniciamos desde el primer elemento

Si el privote es mayor que el minimo hacemos swap, si no nada
movemos el pivote al siguiente elemento y buscamos el nuevo minimo hacia la derecha del pivote
