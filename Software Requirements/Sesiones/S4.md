...
### ¿Que localizadores podriamos utilizar para rastrear lo prestado?
...
- **Para objetos de bajo valor:** Se pueden usar localizadores Bluetooth como Tile o TrackR.
- **Para objetos de alto valor:** Se pueden usar localizadores GPS como Spot.
- **Para objetos que se van a prestar con frecuencia:** Se pueden usar localizadores RFID.

**Es importante tener en cuenta que la mejor opción de localizador dependerá de las necesidades específicas de la aplicación Mi Apoyo ITESO.**

**Además de los localizadores, se pueden implementar otras medidas para rastrear lo prestado:**

- **Registro de préstamos:** Se puede crear un registro de préstamos donde se anote la información del objeto prestado, la fecha de préstamo y la fecha de devolución.
- **Sistema de depósitos:** Se puede solicitar un depósito al usuario antes de prestarle un objeto.
- **Comunicación clara:** Es importante que la aplicación tenga una comunicación clara con los usuarios sobre las condiciones de préstamo y las consecuencias de no cumplir con ellas.
